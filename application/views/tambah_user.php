			...
			<div class="chute chute-center">
				<div class="row mb40">
					<div class="form-title">
						<h4><marquee>Silahkan isi data user</marquee></h4>
					</div>
					<br>
					<div class="col-md-11">
					...
					<div class="col-md-6">
						<div class="form-group"> 
							...
							<input type="text" name="nama_user" value="" class="form-control" id="exampleInputEmail1" placeholder="Nama User" required=""> 
						</div> 
						<div class="form-group">
						...
						<div class="form-group"> 
							...
							<input type="text" name="username" value="" class="form-control" id="exampleInputEmail1" placeholder="Username" required=""> 
						</div>
						<div class="form-group"> 
							<label for="exampleInputEmail1">Password</label> 
							<input type="password" name="password" value="" class="form-control" id="exampleInputEmail1" placeholder="Password" required=""> 
						</div>
						<div class="form-group">
