...
<head>
  ...
  <title>Coming Soon Bootstrap Template</title>
  ...
  <style type="text/css">
  .button{
    background: url('<?php echo base_url('assets/smile/SP.png'); ?>')
    ...
    <div class="title">
      <div class="container">
        <div class="col-lg-12 welcome">
          <marquee><h1><font style=font-size:23pt face="Arial" color=#ffffff>SELAMAT DATANG DI BALAI BESAR POM DI PEKANBARU</font></h1></marquee>
            ...
            <div id="countdown_dashboard">
              <div class="countDown">
               <figure class="col-xs-3 .col-sm-3 .col-lg-4" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                ...
                <span><h1><font style=font-size:23pt face="Arial" color=#ffffff>SANGAT PUAS</font><h1></span> 
                </figure>
                ...
                <span><h1><font style=font-size:23pt face="Arial" color=#ffffff>PUAS</font><h1></span>
                </figure>
                ...
                <span><h1><font style=font-size:23pt face="Arial" color=#ffffff>CUKUP PUAS</font><h1></span>
                </figure>
                ...
                <span><h1><font style=font-size:23pt face="Arial" color=#ffffff>KURANG PUAS</font></h1></span>
                </figure>
              </div>
            </div>
  ...
  <footer>
    <div class="col-md-6 col-md-offset-3">
      <div class="text-center">
        <div class="copyright">
          &copy; Balai Besar POM di Pekanbaru
          <div class="credits">
...
<script>
  ...
  $(document).on('submit', '[id^=formdata]', function (e) {
  e.preventDefault();
   ...
   closeOnCancel: false
    ...
    function (isConfirm) {
      if (isConfirm) {
        $.ajax({
          type: 'POST',
          url: '<?php echo base_url().'index.php/Kepuasan/survei'?>',
          data: data,
