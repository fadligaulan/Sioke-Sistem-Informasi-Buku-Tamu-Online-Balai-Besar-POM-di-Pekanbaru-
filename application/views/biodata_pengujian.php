...
<form action="<?php echo base_url() . 'index.php/Biodata/insert_pengujian' ?>" id="form-data" method="post">
    <div class="panel panel-widget forms-panel">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="pangkat" class="form-control" id="exampleInputEmail1" placeholder="Pangkat"
                    required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="instansi" class="form-control" id="exampleInputEmail1" placeholder="Instansi"
                    required="">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="keperluan" class="form-control" id="exampleInputEmail1" placeholder="Keperluan"
                    required="">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail1">Sampel</label>
                <input type="text" name="sampel" class="form-control" id="exampleInputEmail1" placeholder="Sampel"
                    required="">
            </div>
            <div class="form-group">
