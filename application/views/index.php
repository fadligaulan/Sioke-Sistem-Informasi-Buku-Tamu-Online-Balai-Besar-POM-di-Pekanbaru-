...
<body class="cbp-spmenu-push">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="logo">
					<a href="index.html">
						<ul>	
							<li><img src="<?php echo base_url('assets/images/logo1.png'); ?>" alt="" /></li>
							<li><h1>Baxster</h1></li>
	...
	<!-- Bootstrap Core JavaScript --> 
		...
		<!-- //real-time-updates -->
		<!-- error-graph -->
		<script language="javascript" type="text/javascript" src="<?php echo base_url('assets/js/jquery.flot.errorbars.js'); ?>"></script>
		<script language="javascript" type="text/javascript" src="<?php echo base_url('assets/js/jquery.flot.navigate.js'); ?>"></script>
		<script type="text/javascript">
			$(function() {
		...
		<script src="<?php echo base_url('assets/js/Chart.Doughnut.js'); ?>"></script>
		<script>
