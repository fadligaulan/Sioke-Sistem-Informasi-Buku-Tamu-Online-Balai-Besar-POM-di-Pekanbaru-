<!--footer-->
		 <div class="dev-page">
            ...
            <div class="dev-page-footer dev-page-footer-fixed"> 
				...
				<div class="container">
					<div class="copyright">
						<p><marquee>© TIK BBPOM di Pekanbaru.<a href="http://w3layouts.com/">Selamat datang di Balai Besar POM di Pekanbaru</a></marquee></p>
					</div>
					<!-- page footer buttons -->
								  ...
								  <div class="list-wrpaaer" style="height:200px;">
									 <ul class="list-aggregate" id="marquee-horizontal">
									   <li class="fat-l" style="width:300px">
										<img src="<?php echo base_url('assets/images/slider/foto1.jpg'); ?>"  alt="">
									   </li>
									   
									   <li class="fat-l" style="width:300px">
										<img src="<?php echo base_url('assets/images/slider/foto2.jpg'); ?>" alt="">
									   </li>
									   
									   <li class="fat-l" style="width:300px">
										 <img src="<?php echo base_url('assets/images/slider/foto3.jpg'); ?>" alt="">
									   </li>

									   <li class="fat-l" style="width:300px">
										<img src="<?php echo base_url('assets/images/slider/foto4.jpg'); ?>" alt="">
									   </li>
										<li class="fat-l" style="width:300px">
										<img src="<?php echo base_url('assets/images/slider/foto5.jpg'); ?>" alt="">
									   </li>
									   <li class="fat-l" style="width:300px">
										 <img src="<?php echo base_url('assets/images/slider/foto6.jpg'); ?>" alt="">
									   </li>
